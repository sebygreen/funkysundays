...
export const event = {
    all: cache(async () => {
        ...
        try {
            ...
            return data.map(
                (i) => new Event(i, { expanded: false, artist: false }),
            );
        } catch (e) {
            error(e);
        }
    ...
    one: cache(async (id, expanded) => {
        ...
        try {
            ...
            return new Event(data, { expanded: expanded, artist: false });
        } catch (e) {
            error(e);
        }
    }),
...
export const artist = {
    ...
    one: cache(async (id, expanded) => {
        let collection = "artists";
        let fields = {
            main: ["id", "collectionId", "picture", "name", "description"],
            links: {
                prefix: "expand.links",
        ...
        try {
            ...
            return new Artist(data, { expanded: expanded });
        } catch (e) {
            error(e);
        }
    }),
